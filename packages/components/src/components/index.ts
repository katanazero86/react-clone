...
export { default as InputPasswordComponent } from './Inputs/Password/InputPasswordComponent';
...
export { default as FacebookIconComponent } from './Icons/Facebook/FacebookIconComponent';
export { default as GoogleIconComponent } from './Icons/Google/GoogleIconComponent';
